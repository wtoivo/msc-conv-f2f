...
* Open R Studio and ensure the environment is clear.   
* Download <a href="stubs\stub-4.3.Rmd" download>`stub-3.3.Rmd`</a> and <a href="RTA_study1.csv" download>`RTA_study1.csv`</a> and save them in your Chapter 4 folder. Make sure that you do not change the file names at all.
