...
* Download <a href="stubs\stub-3.2.Rmd" download>`stub-3.2.Rmd`</a> into your Chapter 3 folder.
* Open R Studio and ensure the environment is clear.  
* Open the Markdown stub file and ensure that the working directory is set to your Chapter 3 folder.    
...
* Download <a href="stubs\stub-3.3.Rmd" download>`stub-3.3.Rmd`</a> and <a href="PongBlueRedBack 1-16 Codebook.csv" download>`PongBlueRedBack 1-16 Codebook.csv`</a> into your Chapter 3 folder.  
