...
* Download <a href="stubs\stub-7.1.Rmd" download>`stub-7.1.Rmd`</a> and <a href="Zhang et al. 2014 Study 3.csv" download>Zhang et al. 2014 Study 3.csv</a> and save them in your Chapter 7 folder. Make sure that you do not change the file names at all.
* Open the Markdown stub and ensure that the working directory is set to your Chapter 7 folder. 
...
* Open R Studio and ensure the environment is clear.  
* Download <a href="stubs\stub-7.2.Rmd" download>`stub-7.2.Rmd`</a> and save it in your Chapter 7 folder.  
