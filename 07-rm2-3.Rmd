...
* Open R Studio and ensure the environment is clear.  
* Download <a href="stubs\stub-7.2.Rmd" download>`stub-7.2.Rmd`</a> and save it in your Chapter 7 folder. Make sure that you save the file then open it, if you open it straight from the website things might go wrong.  
