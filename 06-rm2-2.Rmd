...
* Download the `evaluators.csv` file from Moodle and save it in your Lab 2 folder. Make sure that you do not change the file name at all.    
...
2. Use a non-parametric test. The non-parametric equivalent of the independent t-test is the Mann-Whitney and the equivalent of the paired-samples t-test  is the Wilcoxon. See the Chapter \@ref(supp) for more information.
...
2. In `cohensD()` you shoudl specify `method = paired` rather than `unequal`
