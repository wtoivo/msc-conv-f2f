...
* Download <a href="stubs\stub-6.1.Rmd" download>`stub-6.1.Rmd`</a> and <a href="messy.csv" download>`messy.csv`</a>and save them in your Chapter 6 folder. Make sure that you do not change the file names at all.  
...
* Open R Studio and ensure the environment is clear.   
* Download <a href="stubs\stub-6.2.Rmd" download>`stub-6.2.Rmd`</a> and <a href="evaluators.csv" download>`evaluators.csv`</a> and save them in your Chapter 6 folder. Make sure that you do not change the file names at all.    
