...
* To 2 decimal places, what proportion of the variance in wellbeing scores does the overall model explain? `r fitb("9.38")`
...
* Run the below code. Do any of the predictors show evidence of mulitcollinearity? `r mcq(c("thours_c", "male_c", "thours_c:male_c", answer = "There is no evidence of multicollinearity"))`
