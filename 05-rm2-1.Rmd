...
knitr::include_graphics("images/rmd_dialogue.png")
...
* Download <a href="stubs\stub-5.2.Rmd" download>`stub-5.2.Rmd`</a> and <a href="MillerHadenData.csv" download>`MillerHadenData.csv`</a> and save them in your Chapter 5 folder. Make sure that you do not change the file names at all.  
* Open the Markdown stub file and ensure that the working directory is set to your Chapter 5 folder.
