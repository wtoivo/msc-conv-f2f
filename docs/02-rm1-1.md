...
**My name is Emily and I am 34 years old. It is 314 days until my birthday.**
...
* Download <a href="stubs\stub-2.3.Rmd" download>`stub-2.3.Rmd`</a>, <a href="ahi-cesd.csv" download>`ahi-cesd.csv`</a> and `participant-info.csv` <a href="participant-info.csv" download>`participant-info.csv`</a> into your Chapter 2 folder.  
* Open R and ensure the environment is clear.
* Open the stub Markdown document and ensure that the working directory is set to your Chapter 2 folder.
