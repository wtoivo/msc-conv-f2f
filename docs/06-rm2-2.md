...
* Download <a href="stubs\stub-6.1.Rmd" download>`stub-6.1.Rmd`</a>, <a href="messy.csv" download>messy.csv</a>and save it in your Chapter 6 folder. Make sure that you do not change the file names at all.  
