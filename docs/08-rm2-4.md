...
* Download <a href="stubs\stub-8.1.Rmd" download>`stub-8.1.Rmd`</a> and <a href="James Holmes_Expt 2_DATA.csv" download>`James Holmes_Expt 2_DATA.csv`</a> and save them in your Chapter 8 folder. Make sure that you do not change the file name at all. 
* Open the Markdown stub file and ensure the working directory is set to your Chapter 8 folder. 
...
* Open R Studio and ensure the environment is clear.    
* Download <a href="stubs\stub-8.2.Rmd" download>`stub-8.2.Rmd`</a> and <a href="Zhang et al. 2014 Study 3.csv" download>Zhang et al. 2014 Study 3.csv</a> into your Chapter 8 folder. Make sure that you do not change the file names at all.
* Open the Markdown stub file and ensure the working directory is set to your Chapter 8 folder.
...
* Type and run the code that loads `pwr`, `rcompanion`, `car`, `broom`, `afex`, `emmeans` and `tidyverse` using the `library()` function.
